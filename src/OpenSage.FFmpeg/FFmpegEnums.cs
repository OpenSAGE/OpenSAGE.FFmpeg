...
namespace OpenSage.FFmpegNative
{
    ...
    internal enum AVHWDeviceType : int
    {
    ...
    internal enum AVHWFrameTransferDirection : int
    {
    ...
    internal enum AVPacketSideDataType : int
    {
        ...
        /// <summary>The number of side data types. This is not part of the internal API/ABI in the sense that it may change when new side data types are added. This must stay the last enum value. If its value becomes huge, some code using it needs to be updated as it assumes it to be smaller than other limits.</summary>
        @AV_PKT_DATA_NB = 26,
    }
