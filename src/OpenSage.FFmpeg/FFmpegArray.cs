...
#pragma warning disable 169
    ...
    internal unsafe struct short_array2
    {
        ...
        internal void UpdateFrom(short[] array)
        {
    ...
    {
        internal static readonly int Size = 3;
        byte* _0; byte* _1; byte* _2;

        internal byte* this[uint i]
        {
        ...
        internal void UpdateFrom(byte*[] array)
        {
    ...
    internal unsafe struct int_array3
    {
        ...
        internal void UpdateFrom(int[] array)
        {
    ...
    internal unsafe struct AVComponentDescriptor_array4
    {
        ...
        internal AVComponentDescriptor this[uint i]
        {
    ...
    internal unsafe struct long_array4
    {
        ...
        internal void UpdateFrom(long[] array)
        {
    ...
    {
        internal static readonly int Size = 5;
        fixed int _[5];
    ...
    internal unsafe struct AVBufferRef_ptrArray8
    {
        ...
        internal AVBufferRef* this[uint i]
        {
    ...
    internal unsafe struct byte_array8
    {
        internal static readonly int Size = 8;
        fixed byte _[8];
    ...
    {
        internal static readonly int Size = 17;
        fixed byte _[17];
    ...
    {
        internal static readonly int Size = 399;
        fixed double _[399];
        ...
        internal void UpdateFrom(double[] array)
        {
    ...
    {
        internal static readonly int Size = 798;
        ...
        internal double_array399 this[uint i]
        {
    ...
    {
        internal static readonly int Size = 1024;
        fixed byte _[1024];
    ...
    {
        internal static readonly int Size = 61440;
        fixed byte _[61440];
